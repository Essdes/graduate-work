    ...
    <div class="NextTwoDiv">
        ...
        <div class="CONTENT4">
          <table class="tb">
            <tr class="tr">
              <td class="td">
                <p>1) Антивирусное лечение</p>
                <p>2) Настройка операционной системы </p>
                <p>3) Установка программного обеспечения </p>
                <p>4) Программная чистка </p>
                <p>5) Установка драйверов устройств</p>
                <p>6) Установка антивирусного ПО </p>
                <p>7) Иные услуги </p>
                </td>
              <td class=" td2">
                <p class="ppp"> 500 руб. </p>
                <p class="ppp"> 500 руб. </p>
                <p class="ppp"> 500 руб. </p>
                <p class="ppp"> 500 руб. </p>
                <p class="ppp"> 500 руб. </p>
                <p class="ppp"> 500 руб. </p>
                <p class="ppp"> 900 руб. </p>
              </td>
            </tr>
          </table>
<div class="wrapper">
		...
		<div class="row">
				...
				<nav>
					<div class="nav-wrapper">
						...
						<ul class="right hide-on-med-and-down">
							<li class="dropdown">
								<a  id="showCart"><i class="">shopping_cart</i> <span id="cartCount" class="cart_count">0</span></a>
			...
			<div class="col s4">
				<div class="card">
					<div class="card-image">
						...
						<a class="btn-floating btn-lg halfway-fab waves-effect waves-light pulse red" onclick="cart.addToCart(1, {title: `СТАХАНОВЕЦ 9.10`, price: 14128, image: 'cart/app/img/stah.jpg'})"><i class="">add_shopping_cart</i></a>
					</div>
			...
			<div class="col s4">
				<div class="card">
					<div class="card-image">
						<img src="cart/app/img/stah.jpg">
						<a class="btn-floating btn-lg halfway-fab waves-effect waves-light pulse red" onclick="cart.addToCart(2, {title: `СТАХАНОВЕЦ 9.03`, price: 13650, image: 'cart/app/img/stah.jpg'})"><i class="">add_shopping_cart</i></a>
					</div>
					<div class="card-content">
			...
			<div class="col s4">
				<div class="card">
					<div class="card-image">
						<img src="cart/app/img/stah.jpg">
						<a class="btn-floating btn-lg halfway-fab waves-effect waves-light pulse red" onclick="cart.addToCart(3, {title: `СТАХАНОВЕЦ 9.01`, price: 12280, image: 'cart/app/img/stah.jpg'})"><i class="">add_shopping_cart</i></a>
					</div>
					<div class="card-content">
			...
			<div class="col s4">
				<div class="card">
					<div class="card-image">
						<img src="cart/app/img/stah.jpg">
						<a class="btn-floating btn-lg halfway-fab waves-effect waves-light pulse red" onclick="cart.addToCart(4, {title: `СТАХАНОВЕЦ 9.00`, price: 11550, image: 'cart/app/img/stah.jpg'})"><i class="">add_shopping_cart</i></a>
					</div>
					<div class="card-content">
			...
			<div class="col s4">
				<div class="card">
					<div class="card-image">
						<img src="cart/app/img/stah.jpg">
						<a class="btn-floating btn-lg halfway-fab waves-effect waves-light pulse red" onclick="cart.addToCart(5, {title: `СТАХАНОВЕЦ 8.86`, price: 10350, image: 'cart/app/img/stah.jpg'})"><i class="">add_shopping_cart</i></a>
					</div>
					<div class="card-content">
